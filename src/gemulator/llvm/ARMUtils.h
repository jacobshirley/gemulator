...
{
    uint32_t dont_care;
    uint32_t result = LSL_C(value, amount, dont_care);
    return result;
}
...
{
    uint32_t dont_care;
    uint32_t result = LSR_C(value, amount, dont_care);
    return result;
}

//taken from MathExtras.h
...
{
    uint32_t dont_care;
    uint32_t result = ASR_C(value, amount, dont_care);
    return result;
}
...
{
    uint32_t dont_care;
    uint32_t result = ROR_C(value, amount, dont_care);
    return result;
}
...
{
    uint32_t dont_care;
    uint32_t result = RRX_C(value, carry_in, dont_care);
    return result;
}
                             ...
                             const uint32_t carry_in)
{
    ...
    uint32_t dont_care;
    uint32_t result = Shift_C(value, type, amount, carry_in, dont_care);
    return result;
}
